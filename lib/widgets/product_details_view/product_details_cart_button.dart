                ...
                return pdProvider.quantity == 0
                    ...
                    : CustomCommonButton(
                        ...
                        onPressed: () {
                          ...
                          num stock = 0;
                          var campaignProd =
                              pdProvider.productDetails?.campaignProduct !=
                                  null;
                          ...
                          if (campaignProd) {
                            ...
                            debugPrint((pdProvider.productDetails?.inventory)
                                .toString());
                            stock = pdProvider
                                    .productDetails?.inventory["stock_count"] ??
                                0;
                          }
                          ...
                          Provider.of<CartDataService>(context, listen: false)
                              .addCartItem(
                                  ...
                                  prodCatData: {
                                    "category":
                                        pdProvider.productDetails?.category?.id,
                                    "subcategory": pdProvider
                                        .productDetails?.subCategory?.id,
                                  ...
                                  randomKey:
                                      pdProvider.productDetails?.randomKey,
                                  randomSecret:
                                      pdProvider.productDetails?.randomSecret,
                                  stock: stock);
                        },
                        width: screenWidth / 2.4,
                        isLoading: false,
