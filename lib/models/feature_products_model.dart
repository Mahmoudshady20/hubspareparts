...
FeatureProductsModel? featureProductsModelFromJson(String str) =>
    FeatureProductsModel.fromJson(json.decode(str));

String featureProductsModelToJson(FeatureProductsModel? data) =>
...
class FeatureProductsModel {
  ...
  factory FeatureProductsModel.fromJson(Map<String, dynamic> json) =>
      FeatureProductsModel(
        data: json["data"] == null
            ? []
